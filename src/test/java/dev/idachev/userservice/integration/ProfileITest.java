...
class ProfileITest {
    ...
    // Mock TokenBlacklistService to satisfy context creation (even if not used
    // directly)
    @MockitoBean
    ...
    private String getAuthToken(String username, String email, String password) throws Exception {
        ...
        userRepository.findByUsername(username).orElseGet(() -> createDefaultVerifiedUser(username, email, password));
